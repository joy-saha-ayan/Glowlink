...
try {
    ...
    if ($result->num_rows > 0) {
        ...
        die("<div style='text-align:center; padding:50px; font-family:sans-serif;'><h2>Product not found!</h2><a href='index.php'>Go back</a></div>");
    }
...
<body class="text-slate-800 p-4 md:p-8">
    ...
    <div class="max-w-5xl mx-auto space-y-8">
        ...
        <a href="index.php" class="inline-flex items-center gap-2 text-slate-500 hover:text-rose-600 font-bold transition">
